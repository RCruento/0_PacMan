...
public class AcceuilEcran implements Screen, InputProcessor {
    ...
    public void renderWelcomeInstructions(SpriteBatch batch) {
        String text = "Dev_Mobile_Pacman_2019/2020";
        text = text + "\nPressez votre clavier pour commencer !";
    ...
    public boolean keyDown(int keycode) {
        Gdx.app.log(getClass().getSimpleName(), "Pressez n'importe quoi sur votre clavier");
        JeuEcran screen = new JeuEcran(mGame);
