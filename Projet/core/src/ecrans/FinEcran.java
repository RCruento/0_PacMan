...
public class FinEcran implements Screen, InputProcessor {
    ...
    public FinEcran(boolean won, int score, World world, Game game) {
        this.won = won;
        setScore(score);
        setGame(game);
        setWorld(world);
    ...
    public void render(float delta) {
        ...
        batch.begin();
        if (won) {
            text = "Bravo vous avez gagne rien du tout :D !";
        }
        else {
            text = "Noob !";
        }
        text = text + "\nScore = " + score + "\n Appuyez sur Q pour quitter.\n" +
                "Autre touche pour rejouer";
